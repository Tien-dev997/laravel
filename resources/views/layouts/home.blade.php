                                    ...
                                    <ul class="list-cart">
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <div class="info fl-right">
                                                ...
                                                <a href="{{route('detail_product',[$item->options->slug,$item->id])}}" title="" class="product-name"><p class="price">{{number_format($item->price,0,',','.')}}đ</p></a>
                                                    <a href="{{route('detail_product',[$item->options->slug,$item->id])}}" title="" class="product-name"><p class="qty">Số lượng: <span>{{$item->qty}}</span></p></a>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
