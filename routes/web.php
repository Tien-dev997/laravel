...
// Route::get('/{slug}','IndexController@page')->name('pages');
...
// Route::get('/{slug}/{id}','IndexController@product')->name('product_cat');
...
// Route::get('/detail-product/{slug}/{id}','IndexController@detail_product')->name('detail_product');
